...
const ListItem = ({id, title, description, image}) => {
  ...
  return (
    <li className="flex justify-between gap-x-6 py-5">
      ...
      <button onClick={deleteItem} className="self-center  rounded-md bg-white px-2.5 py-1.5 text-sm font-semibold text-red-700 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">
        Delete
      </button>
    </li>
  );
