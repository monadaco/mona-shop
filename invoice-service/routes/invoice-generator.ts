    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          ...
          <tr>
            <td class="free-text">
              We'll let you know as soon as your items have shipped. <br/>
            </td>
          </tr>
          <tr>
            <td class="w320">
                      ...
                      <tr>
                        <td class="mini-block-padding">
                          <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">
                            <tr>
                              <td class="mini-block">
                                <span class="header-sm">Shipping Info</span><br />
                                ${fullName} <br />
                                ${email} <br />
                                <br /><br />
                              </td>
...
${ProductOrders.filter((i) => i.amount > 0)
  .map((i) => {
    return ` <tr>
                    <td class="item-col item">
                      <table cellspacing="0" cellpadding="0" width="100%">
                        <tr>
                          <td class="mobile-hide-img">
                            <a href=""><img width="110" height="92" src="${i.Product.image}" alt="item1"></a>
                          </td>
                          <td class="product">
                            <span style="color: #4d4d4d; font-weight:bold;">Golden Earings</span> <br />
                            ${i.Product.description.slice(0, 20)}...
                          </td>
                        </tr>
                      </table>
                    </td>
  ...
  .join("")}
                  ...
                  <tr>
                    ...
                    <td class="item-col price" style="text-align: left; border-top: 1px solid #cccccc;">
                      <span class="total-space">$${total}.00</span> <br />
                      <span class="total-space">$0.00</span>  <br />
                      <span class="total-space" style="font-weight:bold; color: #4d4d4d">$${total}.00</span>
                    </td>
                  </tr>  
                </table>
              </td>
        ...
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          <tr>
            <td style="padding: 25px 0 25px">
              <strong>Demo shop app</strong><br />
              1234 Some St <br />
              Cat Island <br /><br />
            </td>
          </tr>
